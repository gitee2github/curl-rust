            ...
            unsafe {
                ...
                curl_dbg_free(
                    *((*http).push_headers).offset(
                    ...
                    127 as libc::c_int,
                    b"http2.c\0" as *const u8 as *const libc::c_char,
                );
...
extern "C" fn get_transfer(mut c: *mut http_conn) -> *mut Curl_easy {
    unsafe {
        ...
        if !c.is_null() && !((*c).trnsfr).is_null() {
        } else {
            __assert_fail(
                b"c && c->trnsfr\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                230 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 51], &[libc::c_char; 51]>(
                    b"struct Curl_easy *get_transfer(struct http_conn *)\0",
                ))
                .as_ptr(),
            );
        }
...
extern "C" fn drained_transfer(mut data: *mut Curl_easy, httpc: *mut http_conn) {
    unsafe {
        ...
        if (*httpc).drain_total >= (*data).state.drain {
            ...
            __assert_fail(
                b"httpc->drain_total >= data->state.drain\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                464 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 62], &[libc::c_char; 62]>(
                    b"void drained_transfer(struct Curl_easy *, struct http_conn *)\0",
                ))
                .as_ptr(),
            );
        }
        ...
        if (*httpc).drain_total >= (*data).state.drain {
            ...
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 56], &[libc::c_char; 56]>(
                    b"void drain_this(struct Curl_easy *, struct http_conn *)\0",
                ))
                .as_ptr(),
            );
        };
...
extern "C" fn duphandle(data: *mut Curl_easy) -> *mut Curl_easy {
    unsafe {
        ...
        if !second.is_null() {
            ...
            #[cfg(CURLDEBUG)]
            let mut http: *mut HTTP = curl_dbg_calloc(
...
extern "C" fn set_transfer_url(data: *mut Curl_easy, hp: *mut curl_pushheaders) -> i32 {
    unsafe {
        ...
        let mut v: *const i8 = 0 as *const libc::c_char;
    ...
    unsafe {
        ...
        'fail: loop {
            if ((*(*data).multi).push_cb).is_some() {
                ...
                if stream.is_null() {
                    Curl_failf(data, b"Internal NULL stream!\0" as *const u8 as *const libc::c_char);
                    ...
                    if rv > 0 as libc::c_int && rv <= 2 as libc::c_int {
                        ...
                        __assert_fail(
                                ...
                                (*::std::mem::transmute::<
                                    ...
                                    &[libc::c_char; 89],
                                >(
                                    b"int push_promise(struct Curl_easy *, struct connectdata *, const nghttp2_push_promise *)\0",
                                ))
                                    .as_ptr(),
                            );
                    }
                ...
                if rc as u64 != 0 {
                    Curl_infof(
                        data,
                        b"failed to add handle to multi\0" as *const u8 as *const libc::c_char,
                    );
                    http2_stream_free((*newhandle).req.p.http);
                    (*newhandle).req.p.http = 0 as *mut HTTP;
                    Curl_close(&mut newhandle);
                ...
                if rv != 0 {
                    Curl_infof(
                        data,
                        b"failed to set user_data for stream %d\0" as *const u8 as *const libc::c_char,
                        (*frame).promised_stream_id,
                    );
                    #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
                                __assert_fail(
        ...
        match (*frame).hd.type_0 {
            ...
            NGHTTP2_HEADERS => {
                if !(*stream).bodystarted {
                    ...
                    #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
                    if !((*stream).mem).is_null() {
                    } else {
                        __assert_fail(
                                b"stream->mem\0" as *const u8 as *const libc::c_char,
                                b"http2.c\0" as *const u8 as *const libc::c_char,
                                ...
                                (*::std::mem::transmute::<
                                    ...
                                    &[libc::c_char; 68],
                                >(
                                    b"int on_frame_recv(nghttp2_session *, const nghttp2_frame *, void *)\0",
                                ))
                                    .as_ptr(),
                            );
                    }
            ...
            NGHTTP2_PUSH_PROMISE => {
                ...
                if rv != 0 {
                    ...
                    if rv > 0 as libc::c_int && rv <= 2 as libc::c_int {
                        ...
                        __assert_fail(
                        b"(rv > 0) && (rv <= 2)\0" as *const u8 as *const libc::c_char,
                        b"http2.c\0" as *const u8 as *const libc::c_char,
                    ...
                    if nghttp2_is_fatal(h2) != 0 {
                        ...
                        if rv == 2 {
                            ...
                            Curl_infof(
                                data_s,
                                b"Fail the parent stream (too)\0" as *const u8
                                    as *const libc::c_char,
                            );
                            return NGHTTP2_ERR_CALLBACK_FAILURE;
                        }
...
extern "C" fn on_data_chunk_recv(
    ...
    unsafe {
        ...
        if stream_id != 0 {
            ...
            __assert_fail(
                b"stream_id\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                ...
                (*::std::mem::transmute::<
                    ...
                    &[libc::c_char; 93],
                >(
                    b"int on_data_chunk_recv(nghttp2_session *, uint8_t, int32_t, const uint8_t *, size_t, void *)\0",
                ))
                    .as_ptr(),
            );
        }
    ...
    unsafe {
        ...
        if stream_id != 0 {
            ...
            if rv != 0 {
                Curl_infof(
                    data_s,
                    b"http/2: failed to clear user_data for stream %d!\0" as *const u8 as *const libc::c_char,
                    stream_id,
                );
                #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
                __assert_fail(
                    ...
                    (*::std::mem::transmute::<&[u8; 66], &[libc::c_char; 66]>(
                        b"int on_stream_close(nghttp2_session *, int32_t, uint32_t, void *)\0",
                    ))
                    .as_ptr(),
                );
            }
    ...
    unsafe {
        ...
        if stream_id != 0 {
            ...
            (*::std::mem::transmute::<
                ...
                &[libc::c_char; 123],
            >(
                b"int on_header(nghttp2_session *, const nghttp2_frame *, const uint8_t *, size_t, const uint8_t *, size_t, uint8_t, void *)\0",
            ))
                .as_ptr(),
        );
        }
        ...
        stream = (*data_s).req.p.http;
        if stream.is_null() {
            Curl_failf(data_s, b"Internal NULL stream!\0" as *const u8 as *const libc::c_char);
            return NGHTTP2_ERR_CALLBACK_FAILURE;
        }
        ...
        if (*frame).hd.type_0 == NGHTTP2_PUSH_PROMISE {
            ...
            if strcmp(b":authority\0" as *const u8 as *const libc::c_char, name as *const libc::c_char) == 0 {
            ...
            if ((*stream).push_headers).is_null() {
                ...
                match () {
                    ...
                    #[cfg(CURLDEBUG)]
                    _ => {
                        (*stream).push_headers = curl_dbg_malloc(
                            ((*stream).push_headers_alloc).wrapping_mul(::std::mem::size_of::<
                                *mut libc::c_char,
                            >(
                            )
                                as libc::c_ulong),
            ...
            ) == 0
        {
            ...
            if (*stream).status_code != -(1 as libc::c_int) {
                ...
                __assert_fail(
                b"stream->status_code != -1\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
            ...
            if rv != 0 {
                ...
                __assert_fail(
                    ...
                    (*::std::mem::transmute::<&[u8; 48], &[libc::c_char; 48]>(
                        b"void Curl_http2_done(struct Curl_easy *, _Bool)\0",
                    ))
                    .as_ptr(),
                );
            }
            ...
            match () {
                ...
                _ => {
                    (*conn).proto.httpc.inbuf =
                        Curl_cmalloc.expect("non-null function pointer")(H2_BUFSIZE as size_t)
                            as *mut i8;
                }
                #[cfg(CURLDEBUG)]
                _ => {
                    (*conn).proto.httpc.inbuf = curl_dbg_malloc(
...
pub extern "C" fn Curl_http2_request_upgrade(req: *mut dynbuf, data: *mut Curl_easy) -> CURLcode {
    unsafe {
        ...
        if binlen <= 0 {
            Curl_failf(
                data,
                b"nghttp2 unexpectedly failed on pack_settings_payload\0" as *const u8 as *const libc::c_char,
            );
            Curl_dyn_free(req);
    ...
    unsafe {
        ...
        if nghttp2_session_check_request_allowed((*httpc).h2) == 0 as libc::c_int {
            ...
            Curl_conncontrol(
                (*data).conn,
                1 as libc::c_int,
                b"http/2: No new requests allowed\0" as *const u8 as *const libc::c_char,
            );
        }
            ...
            if (*stream).error != 0 {
                *err = CURLE_HTTP2;
                ...
                Curl_conncontrol(
                    (*data).conn,
                    1 as libc::c_int,
                    b"GOAWAY received\0" as *const u8 as *const libc::c_char,
                );
                *err = CURLE_OK;
            }
            return -1;
...
extern "C" fn http2_handle_stream_close(
    ...
    unsafe {
        ...
        #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
        if (*data).state.drain == 0 as libc::c_int as libc::c_ulong {
        } else {
            __assert_fail(
            b"data->state.drain == 0\0" as *const u8 as *const libc::c_char,
            b"http2.c\0" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<
                ...
                &[libc::c_char; 103],
            >(
                b"ssize_t http2_handle_stream_close(struct connectdata *, struct Curl_easy *, struct HTTP *, CURLcode *)\0",
            ))
                .as_ptr(),
        );
        }
        ...
        if (*stream).error == NGHTTP2_REFUSED_STREAM as u32 {
            ...
            Curl_conncontrol(
                conn,
                1 as libc::c_int,
                b"REFUSED_STREAM\0" as *const u8 as *const libc::c_char,
            );
    ...
    unsafe {
            ...
            || (*data).set.stream_depends_on != (*data).state.stream_depends_on
        {
            ...
            if (*stream).stream_id != -(1 as libc::c_int) {
                ...
                __assert_fail(
                    b"stream->stream_id != -1\0" as *const u8 as *const libc::c_char,
                    b"http2.c\0" as *const u8 as *const libc::c_char,
                    1596 as libc::c_int as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 59], &[libc::c_char; 59]>(
                        b"int h2_session_send(struct Curl_easy *, nghttp2_session *)\0",
                    ))
                    .as_ptr(),
                );
            }
    ...
    unsafe {
        ...
        if (*data).state.drain != 0 && (*stream).memlen != 0 {
            ...
            if (*httpc).pause_stream_id == (*stream).stream_id {
                ...
                __assert_fail(
                b"httpc->pause_stream_id == stream->stream_id\0" as *const u8
                    as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                ...
                (*::std::mem::transmute::<
                    ...
                    &[libc::c_char; 72],
                >(
                    b"ssize_t http2_recv(struct Curl_easy *, int, char *, size_t, CURLcode *)\0",
                ))
                    .as_ptr(),
            );
            }
            ...
            if (*httpc).pause_stream_id != 0 {
                ...
                *err = CURLE_AGAIN;
                ...
                if (*httpc).inbuflen == 0 {
                    ...
                    (*httpc).inbuflen = nread as size_t;
                    #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
                    if (*httpc).nread_inbuf == 0 as libc::c_int as libc::c_ulong {
                    } else {
                        __assert_fail(
                        b"httpc->nread_inbuf == 0\0" as *const u8 as *const libc::c_char,
                        b"http2.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn http2_send(
    ...
    'fail: loop {
        ...
        (*nva.offset(0)).name = b":method\0" as *const u8 as *const libc::c_char as *mut u8;
        ...
        if HEADER_OVERFLOW(*nva.offset(0 as isize)) {
            Curl_failf(
                data,
                b"Failed sending HTTP request: Header overflow\0" as *const u8 as *const libc::c_char,
            );
            break 'fail;
        }
        ...
        (*nva.offset(1)).name = b":path\0" as *const u8 as *const libc::c_char as *mut u8;
        ...
        (*nva.offset(2)).name = b":scheme\0" as *const u8 as *const libc::c_char as *mut u8;
        (*nva.offset(2)).namelen = strlen((*nva.offset(2)).name as *mut i8);
        if (*(*conn).handler).flags & ((1 as i32) << 0 as i32) as u32 != 0 {
            (*nva.offset(2)).value = b"https\0" as *const u8 as *const libc::c_char as *mut u8;
        } else {
            (*nva.offset(2)).value = b"http\0" as *const u8 as *const libc::c_char as *mut u8;
        }
        ...
        while i < nheader {
            ...
            if hlen == 4 && Curl_strncasecompare(b"host\0" as *const u8 as *const libc::c_char, hdbuf, 4) != 0
            {
                authority_idx = i;
                (*nva.offset(i as isize)).name =
                    b":authority\0" as *const u8 as *const libc::c_char as *mut u8;
            ...
            ) as u32
            {
                ...
                HEADERINST_TE_TRAILERS => {
                    (*nva.offset(i as isize)).value =
                        b"trailers\0" as *const u8 as *const libc::c_char as *mut uint8_t;
        ...
        Curl_infof(
            data,
            b"Using Stream ID: %x (easy handle %p)\0" as *const u8 as *const libc::c_char,
            stream_id,
            data as *mut libc::c_void,
        );
...
pub extern "C" fn Curl_http2_setup(data: *mut Curl_easy, mut conn: *mut connectdata) -> CURLcode {
    unsafe {
        ...
        if !((*data).state.buffer).is_null() {
            ...
            __assert_fail(
                b"data->state.buffer\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                2211 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 68], &[libc::c_char; 68]>(
                    b"CURLcode Curl_http2_setup(struct Curl_easy *, struct connectdata *)\0",
                ))
                .as_ptr(),
            );
        }
    ...
    unsafe {
        ...
        if (*data).req.upgr101 == UPGR101_RECEIVED {
            ...
            if rv != 0 {
                Curl_infof(
                    data,
                    b"http/2: failed to set user_data for stream %d!\0" as *const u8 as *const libc::c_char,
                    (*stream).stream_id,
                );
                #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
                __assert_fail(
                    b"0\0" as *const u8 as *const libc::c_char,
                    b"http2.c\0" as *const u8 as *const libc::c_char,
                    2296 as libc::c_int as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 71], &[libc::c_char; 71]>(
                        b"CURLcode Curl_http2_switched(struct Curl_easy *, const char *, size_t)\0",
                    ))
                    .as_ptr(),
                );
            }
        ...
        if (*httpc).nread_inbuf == 0 as libc::c_int as libc::c_ulong {
            ...
            __assert_fail(
                b"httpc->nread_inbuf == 0\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                2342 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 71], &[libc::c_char; 71]>(
                    b"CURLcode Curl_http2_switched(struct Curl_easy *, const char *, size_t)\0",
                ))
                .as_ptr(),
    ...
    unsafe {
        ...
        if !data.is_null() {
            ...
            __assert_fail(
                ...
                b"http2.c\0" as *const u8 as *const libc::c_char,
                2352 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 60], &[libc::c_char; 60]>(
                    b"CURLcode Curl_http2_stream_pause(struct Curl_easy *, _Bool)\0",
                ))
                .as_ptr(),
            );
        }
            ...
            || ((*(*data).conn).proto.httpc.h2).is_null()
        {
            ...
            match () {
                ...
                _ => {
                    ...
                    Curl_infof(
                        data,
                        b"Set HTTP/2 window size to %u for stream %u\0" as *const u8
                            as *const libc::c_char,
                        window,
                        (*stream).stream_id,
                    );
                    let mut window2: uint32_t = nghttp2_session_get_stream_local_window_size(
                        (*httpc).h2,
                        (*stream).stream_id,
                    ) as uint32_t;
                    #[cfg(DEBUGBUILD)]
                    Curl_infof(
                        data,
                        b"HTTP/2 window size is now %u for stream %u\0" as *const u8
                            as *const libc::c_char,
                        window2,
                        (*stream).stream_id,
                    );
...
pub extern "C" fn Curl_http2_add_child(
    ...
    unsafe {
        if !parent.is_null() {
            ...
            #[cfg(CURLDEBUG)]
            let mut dep: *mut Curl_http2_dep = curl_dbg_calloc(
                1 as libc::c_int as size_t,
            ...
            if !((*parent).set.stream_dependents).is_null() && exclusive as i32 != 0 {
                ...
                if (*tail).is_null() {
                    ...
                    b"http2.c\0" as *const u8 as *const libc::c_char,
                    2418 as libc::c_int as libc::c_uint,
                    (*::std::mem::transmute::<
                        &[u8; 77],
                        &[libc::c_char; 77],
                    >(
                        b"CURLcode Curl_http2_add_child(struct Curl_easy *, struct Curl_easy *, _Bool)\0",
                    ))
                        .as_ptr(),
                );
                }
            ...
            if (*tail).is_null() {
                ...
                b"!*tail\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                2429 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<
                    &[u8; 77],
                    &[libc::c_char; 77],
                >(
...
pub extern "C" fn Curl_http2_remove_child(parent: *mut Curl_easy, child: *mut Curl_easy) {
    unsafe {
        ...
        #[cfg(all(DEBUGBUILD, HAVE_ASSERT_H))]
        if (*child).set.stream_depends_on == parent {
        } else {
            __assert_fail(
                b"child->set.stream_depends_on == parent\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                2442 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 69], &[libc::c_char; 69]>(
                    b"void Curl_http2_remove_child(struct Curl_easy *, struct Curl_easy *)\0",
                ))
                .as_ptr(),
            );
        }
        ...
        if !data.is_null() {
            ...
            __assert_fail(
                b"data\0" as *const u8 as *const libc::c_char,
                b"http2.c\0" as *const u8 as *const libc::c_char,
                2449 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 69], &[libc::c_char; 69]>(
                    b"void Curl_http2_remove_child(struct Curl_easy *, struct Curl_easy *)\0",
                ))
                .as_ptr(),
