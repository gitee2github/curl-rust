...
extern "C" fn ftp_pl_insert_finfo(mut data: *mut Curl_easy, mut infop: *mut fileinfo) -> CURLcode {
    ...
    if unsafe {
        compare.expect("non-null function pointer")(
...
pub extern "C" fn Curl_ftp_parselist(
    ...
    'fail: loop {
        ...
        if unsafe { (*parser).os_type as u32 } == OS_TYPE_UNKNOWN as u32 && bufflen > 0 as u64 {
            /* considering info about FILE response format */
            unsafe {
                (*parser).os_type = (if *buffer.offset(0 as isize) as i32 >= '0' as i32
        ...
        while i < bufflen {
            ...
            if unsafe { ((*parser).file_data).is_null() } {
                ...
                unsafe {
                    match () {
                        #[cfg(not(CURLDEBUG))]
                        _ => {
                            (*(*parser).file_data).info.b_data =
                                Curl_cmalloc.expect("non-null function pointer")(160 as size_t)
                                    as *mut libc::c_char;
                        }
                        #[cfg(CURLDEBUG)]
                        _ => {
            ...
            if unsafe { (*finfo).b_used } >= unsafe { ((*finfo).b_size).wrapping_sub(1 as u64) } {
                /* if it is important, extend buffer space for file data */
                #[cfg(not(CURLDEBUG))]
                let mut tmp: *mut libc::c_char = unsafe {
                    Curl_crealloc.expect("non-null function pointer")(
                ...
                if !tmp.is_null() {
                    ...
                    unsafe {
                        (*finfo).b_size =
                            ((*finfo).b_size as u64).wrapping_add(160 as u64) as size_t as size_t;
                    ...
                    1 => {
                        match (*parser).state.UNIX.main as u32 {
                                ...
                                match (*parser).state.UNIX.sub.total_dirsize as u32 {
                                    0 => {
                                        if c as i32 == 't' as i32 {
                                            ...
                                            (*parser).item_length =
                                                ((*parser).item_length).wrapping_add(1);
                                        } else {
                                    ...
                                    1 => {
                                        ...
                                        if c as i32 == '\r' as i32 {
                                            ...
                                            (*parser).item_length =
                                                ((*parser).item_length).wrapping_sub(1);
                                            //    let ref mut fresh17 = (*finfo).b_used;
                                            (*finfo).b_used = ((*finfo).b_used).wrapping_sub(1);
                                        } else if c as i32 == '\n' as i32 {
                                            *((*finfo).b_data).offset(
                                                ((*parser).item_length).wrapping_sub(1 as u32)
                                                    as isize,
                                            ) = 0 as libc::c_char;
                                            if strncmp(
                                            ...
                                            ) == 0 as i32
                                            {
                                                let mut endptr: *mut libc::c_char =
                                                    ((*finfo).b_data).offset(6 as isize);
                                                /* here we can deal with directory size, pass the leading
                                                whitespace and then the digits */
                                                while Curl_isspace(*endptr as u8 as i32) != 0 {
                                                    endptr = endptr.offset(1);
                                                }
                                                while Curl_isdigit(*endptr as u8 as i32) != 0 {
                                                    endptr = endptr.offset(1);
                                                }
                                                if *endptr != 0 {
                            ...
                            2 => {
                                ...
                                if (*parser).item_length <= 9 as u32 {
                                ...
                                } else if (*parser).item_length == 10 as u32 {
                                    let mut perm: u32 = 0;
                                    if c as i32 != ' ' as i32 {
                                        (*parser).error = CURLE_FTP_BAD_FILE_LIST;
                                        // printf(b"hanxj\n\0" as *const u8 as *const libc::c_char);
                                    ...
                                    *((*finfo).b_data).offset(10 as isize) = 0 as libc::c_char;
                                    ...
                                    0 => {
                                        if c as i32 != ' ' as i32 {
                                            if c as i32 >= '0' as i32 && c as i32 <= '9' as i32 {
                                                (*parser).item_offset =
                                                    ((*finfo).b_used).wrapping_sub(1 as u64);
                                    ...
                                    1 => {
                                        ...
                                        if c as i32 == ' ' as i32 {
                                            ...
                                            *((*finfo).b_data).offset(
                                            ...
                                            if *p.offset(0 as isize) as i32 == '\u{0}' as i32
                            ...
                            6 => {
                                match (*parser).state.UNIX.sub.size as u32 {
                                    ...
                                    1 => {
                                        ...
                                        if c as i32 == ' ' as i32 {
                                            ...
                                            *((*finfo).b_data).offset(
                                            ...
                                            if curlx_strtoofft(
                                                ...
                                                == 0
                                            {
                                                if *p_0.offset(0 as isize) as i32 == '\u{0}' as i32
                                        ...
                                        } else if Curl_isdigit(c as i32) == 0 {
                                            (*parser).error = CURLE_FTP_BAD_FILE_LIST;
                                            // printf(b"hanxj\n\0" as *const u8 as *const libc::c_char);
                                            break 'fail;
                                        }
                            ...
                            9 => {
                                match (*parser).state.UNIX.sub.symlink as u32 {
                                    ...
                                    1 => {
                                        ...
                                        } else if c as i32 == '\r' as i32 || c as i32 == '\n' as i32
                                        {
                                            (*parser).error = CURLE_FTP_BAD_FILE_LIST;
                                            // printf(b"hanxj\n\0" as *const u8 as *const libc::c_char);
                                            break 'fail;
                    ...
                    2 => {
                        match (*parser).state.NT.main as u32 {
                            0 => {
                                ...
                                } else if (*parser).item_length == 9 as u32 {
                                    if c as i32 == ' ' as i32 {
                                ...
                                match (*parser).state.NT.sub.filename as u32 {
                                    ...
                                    1 => {
                                        ...
                                        if c as i32 == '\r' as i32 {
                                            ...
                                            *((*finfo).b_data)
                                                .offset(((*finfo).b_used).wrapping_sub(1 as u64)
