...
extern "C" fn gtls_connect_step1(
    ...
    unsafe {
        ...
        *certverifyresult = 0 as i64;
        ...
        #[cfg(not(CURL_DISABLE_PROXY))]
        let SSL_SET_OPTION_key = if CURLPROXY_HTTPS as u32 == (*conn).http_proxy.proxytype as u32
            && ssl_connection_complete as u32
                != (*conn).proxy_ssl[(if (*conn).sock[1 as usize] == -(1 as i32) {
                    0 as i32
                } else {
...
extern "C" fn gtls_connect_step3(
    ...
    >(
        ...
        #[cfg(CURL_DISABLE_PROXY)]
        let SSL_PINNED_PUB_KEY_void = (*data).set.str_0[STRING_SSL_PINNEDPUBLICKEY as usize];
        ...
        */
        #[cfg(not(CURL_DISABLE_VERBOSE_STRINGS))]
        algo = gnutls_x509_crt_get_pk_algorithm(x509_cert, &mut bits) as u32; /* public key algorithm's parameters */
        #[cfg(not(CURL_DISABLE_VERBOSE_STRINGS))]
        Curl_infof(
            data,
...
extern "C" fn gtls_connect_common(
    ...
    unsafe {
        ...
        *done = ssl_connect_1 as u32 == (*connssl).connecting_state as u32;
        return CURLE_OK;
    }
}
