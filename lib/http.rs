...
pub unsafe extern "C" fn Curl_http_input_auth(
    ...
    while *auth != 0 {
        ...
        ) != 0 && is_valid_auth_separator(*auth.offset(6 as libc::c_int as isize)) != 0
        {
...
unsafe extern "C" fn readmoredata(
    ...
    *fresh19 = (*fresh19 as libc::c_ulong).wrapping_sub(fullsize) as curl_off_t
        as curl_off_t;
    return fullsize;
}
#[no_mangle]
    ...
    if result as u64 == 0 {
        ...
        *bytes_written += amount;
        if !http.is_null() {
            ...
            *fresh20 = (*fresh20 as libc::c_ulong).wrapping_add(bodylen) as curl_off_t
                as curl_off_t;
            ...
            if !((*data).set.postfields).is_null() {
                    ...
                    && ((*conn).bits).authneg() as libc::c_int != 0
                {
                    ...
                    if ((*conn).bits).authneg() == 0 {
                        ...
                        *fresh58 = &mut (*http).postdata as *mut *const libc::c_char
                            as *mut libc::c_char;
                    }
                }
            }
...
pub unsafe extern "C" fn Curl_http_statusline(
    ...
    match (*k).httpcode {
        304 => {
            ...
            current_block_25 = 13210731283975436821;
        }
        204 => {
            current_block_25 = 13210731283975436821;
        }
